...
const Index = () => {
  ...
  if (testStarted) {
    return <PersonalityTest onBack={() => setTestStarted(false)} />;
  }
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-4">
              ...
              <CardDescription className="text-gray-600 font-medium">Howard Gardner's Multiple Intelligence Theory</CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              ...
              <p className="text-gray-600 text-center text-sm">56 questions across 3 comprehensive parts</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-4">
              ...
              <CardDescription className="text-gray-600 font-medium">Mini MBTI-Style Assessment</CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              <div className="space-y-3 mb-4">
                <div className="flex items-center text-sm text-gray-600">
          ...
          <Card className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-4">
              ...
              <CardDescription className="text-gray-600 font-medium">VARK Learning Preferences Model</CardDescription>
            </CardHeader>
            <CardContent className="pt-0">
              <div className="space-y-3 mb-4">
                <div className="flex items-center text-sm text-gray-600">
              ...
              <p className="text-gray-600 text-center text-sm">10 targeted questions to optimize your learning</p>
            </CardContent>
          </Card>
        </div>
              ...
              <div>
                ...
                <ul className="space-y-4 text-gray-600">
                  <li className="flex items-center">
                    ...
                    <span className="font-medium">106 scientifically-designed questions</span>
                  </li>
                  <li className="flex items-center">
